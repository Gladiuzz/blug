                    ...
                    <div class="col-lg-8 mx-auto">
                        <article class="card mb-4">
                            ...
                            <div class="post-slider">
                                <img src="{{ asset('storage/post/' . $item->thumbnail) }}" class="card-img-top" alt="post-thumb" style="object-fit: cover; height: 400px">
                            </div>

                            <div class="card-body">
                                <h3 class="mb-3"><a class="post-title" href="{{ route('author-detail', ['name' => $item->author->name]) }}">{{ $item->title }}</a></h3>
                                <ul class="card-meta list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <i class="ti-timer"></i>{{ \Carbon\Carbon::parse($item->created_at)->diffForHumans() }}
                                    </li>
                                    <li class="list-inline-item">
                                ...
                                <a href="{{ route('blog-detail', ['title' => $item->title]) }}" class="btn btn-outline-primary">Read More</a>
                            </div>
                        </article>
                    </div>
                @endforeach
